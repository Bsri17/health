...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Reply Letter For Clinical Nursing Notes Report</h2><%String patient =request.getParameter("patient_name");
...
try 
	{		
				...
				{
						%>
          <h3 align="justify">Reply Letter For CDA Report Already Sent !!</h3>
          <%
				}
				else
				{
          ...
          <table width="589" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
            <tr>
              <th width="241" height="45" bgcolor="#666666" scope="col"><span class="style63">Sections In Clinical Nursing Notes Body </span></th>
