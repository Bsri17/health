...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Generated Clinical Nursing Notes </span></h2>
          <p>&nbsp;</p>
...
try 
	{		
            ...
            <%
				...
				String query="Select *from cloudserver where hospital='hospital_a' "; 
            ...
            <tr>
              ...
              <td><div align="center"><a href="HA_CDA_Details.jsp?usid=<%=i%>">View More ...</a></div></td>
            </tr>
            <%
