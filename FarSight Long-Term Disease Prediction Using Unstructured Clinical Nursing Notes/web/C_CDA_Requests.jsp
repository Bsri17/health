...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Grant Access Permissions </span></h2>
            <p><em><strong>View CDA Access Permission Requests From Doctors And Grant Permissions : </strong></em></p>
            <p>&nbsp;</p>
            <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
              <tr>
                <td width="30" height="30"><div align="center" class="style9"><span class="style50"> ID </span></div></td>
                <td width="168"><div align="center" class="style9"><span class="style50"> Patient (CDA Report) </span></div></td>
                <td width="126"><div align="center" class="style9"><span class="style50"> Doctor Name </span></div></td>
                <td width="139"><div align="center" class="style9"><span class="style50"> Status </span></div></td>
                <%	  
    ...
    try 
	{
		String query="select * from doc_reports where cda_status='Requested' "; 
		...
		while ( rs.next() )
		{
			...
			%>
              ...
              <tr>
                ...
                <td><div align="center"><a href="C_CDA_Details.jsp?pname=<%=s2%>"><%=s2%></a></div></td>
                <td><div align="center"><a href="C_OwnerDetails.jsp?name=<%=s3%>"><%=s3%></a></div></td>
                <%	
		...
		%>
                <td><div>
                    <div align="center"><a href="C_CDA_Requests1.jsp?id=<%=i%>">Permitt For Access</a></div>
                </div></td>
                <%
...
%>
            ...
            <p>&nbsp;</p>
          <div align="right"><a href="C_ViewCDA.jsp">Back</a></div>
        </div>
      </div>
      <div class="sidebar">
