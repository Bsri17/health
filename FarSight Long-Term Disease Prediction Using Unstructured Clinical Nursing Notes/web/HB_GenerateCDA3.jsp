...
try 
	{			
		...
		%>
                    ...
                    <h3 >&nbsp;</h3>
                    <h3 >Clinical Nursing Notes Uploaded Successfully !</h3>
                    <p class="style35">&nbsp;</p>
                    <p align="right" class="style35"><a href="HB_Main.jsp">Back</a></p>
                    <%
