...
try 
	{		
			String query11="Select *from cda_reply_letter where hospital='hospital_b' "; 
          ...
          <form id="form1" name="form1" method="post" action="HB_Reply_Letter.jsp">
...
%>
          ...
          <p align="right"><a href="HB_Main.jsp">Bac</a></p>
        </div>
