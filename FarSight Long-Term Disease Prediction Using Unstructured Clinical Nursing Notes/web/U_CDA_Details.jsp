...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View  Clinical Nursing Notes Repor</span>t</h2>
          <p>
            <%	  
...
try 
	{		
		...
		String str="select *from request where user='"+uname+"' and pname='"+pname+"' and view_per='Permitted'";
		...
		String plan_of_care1 = new String(Base64.decode(plan_of_care.getBytes()));	
          ...
          <table width="615" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="160"><span class="style51">
          ...
          <p>&nbsp;</p>
          <table width="186" height="70" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="160" bgcolor="#000000"><label>
                  <form id="form1" name="form1" method="post" action="U_Reply_Letter.jsp">
                    <div align="center">
		...
		%>
          ...
          <h3>            <span class="style52">You Dont Have<span class="style53"> View Permission </span>From Cloud To View This Content !!</span>
            <%
		}
		connection.close();
	}
