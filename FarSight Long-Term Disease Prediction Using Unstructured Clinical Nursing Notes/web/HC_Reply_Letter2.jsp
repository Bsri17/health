...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Reply Letter For Clinical Nursing Notes</h2><%String patient =request.getParameter("patient_name");
...
try 
	{				
				...
				if ( rs.next() )
				{
						%><h3 align="justify">Clinical Nursing Notes Report Already Sent !!</h3><%
				}
				else
				{	
			...
			connection.createStatement().executeUpdate(strQuery21);
						%><h3 align="justify">Clinical Nursing Notes Report Sent Successfully !!</h3><%
					}
				}
