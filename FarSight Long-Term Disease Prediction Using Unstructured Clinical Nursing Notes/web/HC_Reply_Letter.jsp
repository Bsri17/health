...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Send Reply Letter For Clinical Nursing Notes </h2>
          <p align="justify">
            <%	  
...
try 
	{		
		...
		String query11="Select *from doc_reports where doctor='"+docname+"' and cda_status='Permitted' "; 
		...
		while ( rs11.next() )
		{
          ...
          <p align="center">================================================================================ </p>
					...
					<form id="form1" name="form1" method="post" action="HC_Reply_Letter1.jsp">
					...
					<td width="160" bgcolor="#000000">
					  <label>
					    <div align="center">
					      <input type="submit" name="Submit" value="Send Reply Letter" />
				        </div>
					  </label>
					</td>
					</tr>
