  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="sidebar">
		...
		<li><a href="C_ViewCDA.jsp">View CDA</a></li>
		<li><a href="C_CDA_Replies.jsp">CDA Replies</a></li>
		<li><a href="C_Transactions.jsp">Transactions   </a></li>
		<li><a href="C_CDA_Requests.jsp">CDA Requests</a></li>
		<li><a href="C_User_Requests.jsp">User Requests</a> </li>
		<li><a href="C_Generate_SearchKey.jsp">CDA Search Key</a></li>
		<li><a href="C_UserAutho.jsp">Authorize Patient </a></li>
		<li><a href="C_OwnerAutho.jsp">Authorize Doctor </a></li>
		<li><a href="C_Send_CDA_Reports.jsp">Send CDA Reports </a> </li>
        <li><a href="C_Charts.jsp">Charts</a></li>
        <li><a href="C_Login.jsp">Logout</a></li>
          </ul>
        </div>
