...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Reply Letter For Clinical Nursing Notes Reports </h2>
          <p align="justify">
            <%	  
...
try 
	{		
			String query11="Select *from cda_reply_letter where hospital='hospital_a' "; 
          ...
          <form id="form1" name="form1" method="post" action="HA_Reply_Letter.jsp">
