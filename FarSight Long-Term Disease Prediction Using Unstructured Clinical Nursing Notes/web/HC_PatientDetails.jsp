...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Patient Details (CDA Report) </h2>
          <p align="justify">&nbsp;</p>
          <p align="justify">
            <%	  
...
try 
	{		
		...
		if ( rs11.next() )
		{
          ...
          <p align="justify">            <span class="style50">You Have Not Requested For Access Permission To View The CDA Report.. !! </span>          </p>
          <p align="justify">
            <%
			}
          ...
          <p align="center"><span class="style3">Clinical Document Architecture  (CDA) </span>================================================================================ </p>
