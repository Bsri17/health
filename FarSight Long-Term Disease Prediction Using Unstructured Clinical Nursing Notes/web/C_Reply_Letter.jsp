...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Reply Letter For CDA Report</h2>
          <%String patient =request.getParameter("patient_name");
			%>
          <p>&nbsp;</p>
          <p><em><strong>Reply Letter For CDA Report With Patient Name :</strong></em> <span class="style52"><%=patient%></span></p>
          <p align="justify">
            <%	  
...
%>
          ...
          <label> </label>
<p align="right"><a href="C_CDA_Replies.jsp">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
