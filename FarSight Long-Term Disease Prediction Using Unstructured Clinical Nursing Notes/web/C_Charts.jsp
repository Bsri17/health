  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Charts</h2>
          <p class="style22">Results Based On Allergies : </p>
          <iframe width="600" height="350" src="allergies.jsp"></iframe>
          <p>&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p class="style22">Results Based On Family History: </p>
          <iframe width="600" height="350" src="families.jsp"></iframe>
          <p></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
