...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Reply Letter For Clinical Nursing Notes Report</h2>
          <%String patient =request.getParameter("patient_name");
			%>
          <p>&nbsp;</p>
          <p><em><strong>Reply Letter For Clinical Nursing Notes Report With Patient Name :</strong></em> <span class="style49"><%=patient%></span></p>
          <p align="justify">
            <%	  
...
try 
	{		
          ...
          <p align="justify"><em><strong>Doctor Name :</strong></em> <span class="style49"><%=doctor%></span></p>
          <table width="589" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
            <tr>
              ...
              <th width="170" bgcolor="#666666" scope="col"><span class="style63">CDA Referral Letter </span></th>
              <th width="170" bgcolor="#666666" scope="col"><span class="style63">CDA Reply Letter </span></th>
            </tr>
            <tr>
...
%>
          ...
          <label> </label>
          <p align="right"><a href="HA_Main.jsp">Back</a></p>
        </div>
