...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Health Care Service Provider Login </span></h2>
          <form action="HC_Authentication.jsp" method="post" id="leavereply">
            <label for="name"> <br />
            <span class="style9"><span class="style10">YOU ARE NOT AUTHORIZED BY CLOUD</span> <br />
            <br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Name (required)</span>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label>
            ...
            <p align="center"><span class="style8">New User? click here to <a href="HC_Register.jsp"> Register</a></span></p>
            <p align="center">&nbsp;</p>
          </form>
        </div>
