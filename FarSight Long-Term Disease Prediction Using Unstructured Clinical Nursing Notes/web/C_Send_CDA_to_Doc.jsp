	...
	else
	{
		...
		String query2="Select *from doc_reports where patient='"+s2+"'"; 
			...
			if ( rs2.next() )
			{
				...
				%>
				<strong>CDA Report with <span class="style14">Template ID : <%=s5%></span>  <span class="style12">Already Assigned To Dr . <%=as_doc%></span>  !! </strong></span>
				<span class="style10">
				<%	
			}
			else
			{
				...
				{
					%>
		<strong>CDA Report with <span class="style14">Template ID : <%=s5%></span>  <span class="style13">Assigned Sucessfully To Dr . <%=doctor%>  </span>!! </strong></span>
					<span class="style10">
					<%
				}
