...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Hi <%=application.getAttribute("docname")%> !!  ( Health Care Service Povider )</span></h2>
      ...
      <div class="sidebar">
		...
		<li><a href="HC_ViewCDA.jsp">View Clinical Nursing Notes</a></li>
		<li><a href="HC_Reply_Letter.jsp">Reply Letter  </a></li>
		<li><a href="HC_View_Reply_Letter.jsp">View Reply Letter</a></li>
