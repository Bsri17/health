...
try 
	{		
			String query11="Select *from cda_reply_letter where doctor='"+docname+"'  "; 
          ...
          <form id="form1" name="form1" method="post" action="HC_ViewReply_Letter.jsp">
