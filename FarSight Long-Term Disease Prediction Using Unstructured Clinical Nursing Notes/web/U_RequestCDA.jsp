    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <form id="form" name="form1" method="post" action="U_ViewPerReq1.jsp">
            <a href="U_ViewPerRes.jsp">View  Permission Response </a>
            <p>&nbsp;</p>
            <div align="center">
              <p align="left" class="style17">&nbsp;</p>
              <p align="left" class="style17"> <strong>Enter Patient Name :</strong> 
                <input name="t14" type="text" size="30" />
                  <br />
              </p>
              <p align="left" class="style17"><br />
                  <input type="submit" name="Submit" value="Request View Permission" />
              </p>
            </div>
            </label>
          </form>
